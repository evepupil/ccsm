...
export function SessionToolbar({
  ...
  return (
    <section className="flex min-h-[70px] items-center justify-between gap-[18px] border-b border-border bg-surface px-4 py-2.5 max-[1000px]:min-h-[104px] max-[1000px]:flex-col max-[1000px]:items-start max-[1000px]:gap-2">
      <div className="min-w-0 flex-1">
        <div className="flex min-w-0 items-center gap-2">
          <h1 className="m-0 truncate text-[16px] font-bold leading-tight">
        ...
        <p
          className="mt-1 max-w-[540px] truncate text-[11px] text-muted"
      ...
      <div className="flex flex-[0_0_auto] flex-wrap items-center justify-end gap-3 max-[1000px]:w-full max-[1000px]:justify-start">
        <Select
          selectedKey={sort}
          ...
          className="w-[132px]"
        >
          <Select.Trigger className="h-8 min-w-[132px] text-[12px]">
        ...
        <Switch size="sm" isSelected={showArchived} onChange={onShowArchivedChange}>
        ...
        <Switch
          ...
          className={highestPermissions ? "font-semibold text-danger" : "text-muted"}
        >
