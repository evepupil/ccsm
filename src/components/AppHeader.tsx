  ...
  return (
    <header className="grid grid-cols-[236px_minmax(260px,620px)_minmax(280px,1fr)] items-center gap-[18px] border-b border-border bg-surface px-[14px] pl-4 max-[1000px]:grid-cols-[204px_minmax(240px,1fr)_270px] max-[1000px]:gap-3">
      <div className="flex min-w-0 items-center gap-2.5" aria-label="CCSM">
        <span className="grid h-[34px] w-[34px] flex-[0_0_34px] place-items-center rounded-md border border-accent/25 bg-accent-soft text-accent">
      ...
      <SearchField fullWidth value={searchQuery} onChange={onSearchChange} aria-label="搜索会话">
        <SearchField.Group className="h-9 border border-border bg-surface-secondary shadow-none">
      ...
      <div className="flex min-w-0 items-center justify-end gap-2">
        <Tabs
          ...
          aria-label="会话来源切换"
        >
          <Tabs.List className="h-[34px] min-w-[216px] rounded-md border border-border bg-surface-secondary p-[3px]">
            <Tabs.Tab
              id="claude"
              className="min-w-[104px] rounded-sm px-3 whitespace-nowrap text-[12px]"
            >
